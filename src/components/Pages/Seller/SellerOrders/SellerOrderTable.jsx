import { useOrderBySellerIdQuery } from "../../../../store/service/order/orderApi";
...
const SellerOrderTable = ({ sellerId, search }) => {
  ...
  const { data, isLoading } = useOrderBySellerIdQuery(query);
